  ...
  return (
    <nav className='flex justify-between px-4 h-32 w-full items-center bg-secondary navbar'>
      ...
      <ul className='hidden md:flex flex-end justify-between items-center'>
        <li className='mr-4 text-xl cursor-pointer'>About</li>
        <li className='mr-4 text-xl cursor-pointer'>Projects</li>
        <li className='mr-4 text-xl cursor-pointer'>Contact</li>
      </ul>
      ...
      {nav &&
        <ul className="z-10 flex flex-col justify-center items-center absolute top-0 right-0 h-4/5 w-full bg-gradient-to-b from-secondary to-base-100">
          <li className='m-4 py-5 text-3xl cursor-pointer'>About</li>
          <li className='m-4 py-5 text-3xl cursor-pointer'>Projects</li>
          <li className='m-4 py-5 text-3xl cursor-pointer'>Contact</li>
