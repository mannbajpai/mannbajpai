...
const Hero = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div>
      <h1 className="text-5xl font-bold text-neutral-content"><Typewriter
  options={{
...
/></h1>
      <p className="py-6 text-neutral-content">I am a pasionate developer who likes to make apps and website like this one.
